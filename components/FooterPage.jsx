			...
			<div id="grid">
				...
				<Fade triggerOnce delay={200}>
					<SectionFooterMenu>
						...
						<FooterTextExternalLink href="mailto:bhandaridipika23@gmail.com">
							Email
						</FooterTextExternalLink>
						<FooterTextExternalLink href="tel:+17083089098">
							Phone
						</FooterTextExternalLink>
						<FooterTextExternalLink href="https://www.linkedin.com/in/dipika-bhandari" target="_blank">
							LinkedIn
						</FooterTextExternalLink>
					</SectionFooterMenu>
				</Fade>
				...
				<Fade triggerOnce delay={400}>
					<SectionFooterMenu>
						...
						<FooterTextExternalLink href="https://www.iit.edu/" target="_blank">
							Illinois Institute of Technology
						</FooterTextExternalLink>
						<FooterTextExternalLink href="https://islington.edu.np/" target="_blank">
							Islington College
						</FooterTextExternalLink>
					</SectionFooterMenu>
				</Fade>
				...
				<Fade triggerOnce delay={600}>
					<SectionFooterMenu>
						<FooterTextTitle>Technologies</FooterTextTitle>

						<FooterTextExternalLink href="https://www.python.org/" target="_blank">
							Python
						</FooterTextExternalLink>

						<FooterTextExternalLink href="https://www.djangoproject.com/" target="_blank">
							Django
						</FooterTextExternalLink>

						<FooterTextExternalLink href="https://www.kali.org/" target="_blank">
							Kali Linux
						</FooterTextExternalLink>

						<FooterTextExternalLink href="https://getbootstrap.com/" target="_blank">
							Bootstrap
						</FooterTextExternalLink>
					</SectionFooterMenu>
				</Fade>
